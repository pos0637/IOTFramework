    ...
    public class Protocol
    {
        ...
        public static Protocol Parse(byte[] buffer, int length) {
            ...
            var protocol = new Protocol {
                SrcId = Encoding.UTF8.GetString(buffer.SubArray(0, CLIENT_ID_LENGTH)),
                DstId = Encoding.UTF8.GetString(buffer.SubArray(CLIENT_ID_LENGTH, CLIENT_ID_LENGTH)),
                SessionId = Encoding.UTF8.GetString(buffer.SubArray(CLIENT_ID_LENGTH + CLIENT_ID_LENGTH, SESSION_ID_LENGTH))
            };
